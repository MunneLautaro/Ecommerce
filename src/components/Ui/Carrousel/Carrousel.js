...
export default function Carrousel() {
  ...
  return (
    <div className="flex w-full justify-center px-4">
      <div className="relative flex h-[420px] w-full max-w-4xl flex-col justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950 to-violet-900 px-6 py-6 shadow-2xl flex-shrink-0">
        ...
        <div className="relative flex items-center gap-4">
          <button
            ...
            className="group grid h-12 w-12 place-items-center rounded-full border border-white/10 bg-white/10 text-white shadow-lg transition hover:-translate-x-1 hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/60"
            onClick={handlePrev}
          >
            <ArrowLeft className="transition group-hover:-translate-x-0.5" />
          </button>
